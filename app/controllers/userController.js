...
exports.getFullListTeachers = function (req, res) {
    UserService.getFullListTeachers().then(function (result) {
        if (result) {
            result.map(r => dot.object(r));
            return res.status(200).send({
                data: result
...
exports.ActualizarPromedioMasivo = function (req, res, callback) {
    try {
        ...
        for (let index = 0; index < datos.length; index++) {
            const element = datos[index];
            UserService.CargaMasivaPromedio(element).then(function (result) {
                if (result) {
                    nCorrectos += 1;
                }
            }, function (error) {
...
exports.changeName = function (req, res, callback) {
    UserService.changeName(req.body).then(function (result) {
